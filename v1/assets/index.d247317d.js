...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function Fl(){return new li({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:oa(),fragmentShader:`
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function Nl(){return new li({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:oa(),fragmentShader:`
...
`].filter(tr).join(`
`)),a=Fo(a),a=Wl(a,t),a=ql(a,t),o=Fo(o),o=Wl(o,t),o=ql(o,t),a=Xl(a),o=Xl(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(S=`#version 300 es
